...
# テストディレクトリ
TEST_HOME=$HOME/workspace/CodeStorage/AlgorithmsAndDataStructures/cheetah/test
# テストケースのパス
TEST_PATH=$TEST_HOME/chapter$1
# 実行ファイルのパス
EXEC_PATH=$HOME/workspace/CodeStorage/AlgorithmsAndDataStructures/cheetah/chapter$1
